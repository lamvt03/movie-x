...
public class EmailTemplateUtils {
  ...
  public static String buildRegistrationMail(String fullName, String token, String hostUrl) {
  ...
  public static String buildForgotMail(String fullName, String otpCode){
    return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">"
               + "<html xmlns=\"http://www.w3.org/1999/xhtml\">"
               + "<head>"
               + "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />"
  ...
  public static String buildVideoPurchaseSuccessMail(String fullName, String movieName, Long price, String movieUrl) {
    return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">"
               + "<html xmlns=\"http://www.w3.org/1999/xhtml\">"
               + "<head>"
               + "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\" />"
               + "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" />"
               + "<title>Movie X - Giao dịch mua phim thành công</title>"
               + "</head>"
               + "<body style=\"font-family: Arial, sans-serif; margin: 0; padding: 0;\">"
               + "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">"
               + "<tr>"
               ...
               + "<tr>"
               + "<td style=\"padding: 20px 0 30px 0; color: #ffffff; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;\">"
               + "Bạn đã mua bộ phim <b>" + movieName + "</b> với giá <b>" + price + "</b> VND thành công. Bạn có thể xem phim bằng cách nhấp vào nút dưới đây."
               + "</td>"
               + "</tr>"
               + "<tr>"
               + "<td align=\"center\">"
               + "<a href=\"" + movieUrl + "\" style=\"display: inline-block; padding: 10px 20px; background-color: #D14A2D; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;\">Xem Phim Ngay</a>"
               + "</td>"
               + "</tr>"
               + "</table>"
               + "</td>"
