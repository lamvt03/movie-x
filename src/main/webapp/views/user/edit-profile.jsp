...
<head>
    ...
    <title>${initParam.websiteName} - Chỉnh Sửa Trang Cá Nhân</title>
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="normal__breadcrumb__text">
                    <h2 style="color: var(--secondary-color);">Trang cá nhân</h2>
                    <p style="color: var(--secondary-color);">Chào mừng bạn đến với website chính thức của MOVIE X</p>
                </div>
            </div>
        </div>
    </div>
