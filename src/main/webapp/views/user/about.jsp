...
<head>
    ...
    <title>${initParam.websiteName} - Giới Thiệu</title>
...
<section class="normal-breadcrumb set-bg" style="height: 675px;"
         data-setbg="${pageContext.request.contextPath}/views/user/assets/img/about/banner.png">
    <div class="container">
        <div class="row">
...
<section class="mt-4">
    <div class="row">
        <div class="col-4">
            <img src="${pageContext.request.contextPath}/views/user/assets/img/about/pic-1.png" alt=""/>
        </div>
        <div class="col-8">
