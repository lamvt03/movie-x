...
<link rel="icon" href="${pageContext.request.contextPath}/views/user/assets/img/favicon.png" />
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/views/common/css/bootstrap.min.css" type="text/css">
